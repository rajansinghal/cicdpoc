    ...
    stages {
        stage('Build') {
            steps {
               ...
               sh "docker-machine create --driver amazonec2 --amazonec2-open-port 8080 --amazonec2-open-port 9090  --amazonec2-instance-type t2.micro --amazonec2-region us-east-2 $E2E_DOCKER_MACHINE_NAME"
